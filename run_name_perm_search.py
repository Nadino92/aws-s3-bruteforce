...
def search_file(file_name, scanned_buckets, start_after_value, start_after_line_num, threads, print_bucket_names, output_file):
...
def search_instance(search):
    ...
    while search.bucket_names:
        ...
        bucket_response = check_s3_bucket(bucket_name=bucket_name)
